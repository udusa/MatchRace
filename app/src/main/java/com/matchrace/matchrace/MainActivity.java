...
import com.matchrace.matchrace.classes.GetWeatherTask;
...
public class MainActivity extends FragmentActivity implements LocationListener {
    ...
    //Additions
    private TextView tvWindSpeed, tvWindDeg;
    ...
    public void onLocationChanged(Location location) {
        if (!disableLocation) {
            ...
            // AsyncTask for getting the weather.
            GetWeatherTask getWeather = new GetWeatherTask(tvWindSpeed, tvWindDeg);
            getWeather.execute(C.URL_GET_WEATHER + "lat=" + lat + "&lon=" + lng);
